...
* ESP32-S3 LoRA Development Board [(ESP32-S3-LR1121-HF)](https://www.waveshare.com/esp32-s3-lr1121.htm), [documentation](https://docs.waveshare.com/ESP32-S3-LR1121-XF?variant=ESP32-S3-LR1121-HF-Kit), [custom firmware](https://github.com/KingElrond/ExpressLRS-4.0.1-Custom/tree/main)
...
# Wiring
## Pico 2W
* UART1 - Receives ELRS from ESP32 Dev Board
* SPI0 - Sends Display Data for FPGA
