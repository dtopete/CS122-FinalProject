...
lv_color_t LVGL_HeartRate::get_hr_zone_color(int32_t hr)
{
...
void LVGL_HeartRate::hr_anim_timer_cb(lv_timer_t * timer)
{
    LV_UNUSED(timer);
...
void LVGL_HeartRate::init_section_styles(section_styles_t * styles, lv_color_t color)
{
...
void LVGL_HeartRate::add_section(lv_obj_t * target_scale,
                        int32_t from,
                        int32_t to,
 ...
 */
void LVGL_HeartRate::lv_example_scale_10(void) {
